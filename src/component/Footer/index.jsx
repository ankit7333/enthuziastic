                ...
                <div className={`container mx-auto flex flex-col justify-between`}>
                    <div className={`flex justify-between ${styles.footer__top}`}>
                        <div className={`flex-1 w-25 mr-20 ${styles.footer__left}`}>
                            <a href='www.google.com' className={`bg-no-repeat bg-center bg-cover inline-block ${styles.footer__logo}`} />
                            ...
                            <ul className={`flex items-center gap-5`}>
                                <li>
                                    <a href='www.google.com' className={`bg-no-repeat bg-center bg-cover inline-block ${styles.linkedin}`} />
                                </li>
                                <li>
                                    <a href='www.google.com' className={`bg-no-repeat bg-center bg-cover inline-block ${styles.twitter}`} />
                                </li>
                                <li>
                                    <a href='www.google.com' className={`bg-no-repeat bg-center bg-cover inline-block ${styles.facebook}`} />
                                </li>
                                <li>
                                    <a href='www.google.com' className={`bg-no-repeat bg-center bg-cover inline-block ${styles.youtube}`} />
                                </li>
                            </ul>
                        </div>
